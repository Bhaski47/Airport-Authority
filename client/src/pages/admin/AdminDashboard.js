...
const FormComponent = ({setIsModalOpen,email}) => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}api/admin/fetch/noc`, { email });
    ...
    return (
        <div>
            ...
            <form>
                ...
                <input type="radio" name="bookReturn" value="yes" checked={formData.bookReturn === 'yes'}
                       onChange={handleInputChange}/>
                <label>Yes</label>
                <input type="radio" name="bookReturn" value="no" checked={formData.bookReturn === 'no'}
                       onChange={handleInputChange}/>
                <label>No</label>

                <p>2. Are You A GEM User?</p>
                <input type="radio" name="gemUser" value="yes" checked={formData.gemUser === 'yes'}
                       onChange={handleInputChange}/>
                <label>Yes</label>
                <input type="radio" name="gemUser" value="no" checked={formData.gemUser === 'no'}
                       onChange={handleInputChange}/>
                <label>No</label>
                ...
                {formData.gemUser === 'yes' && (
                    <>
                        ...
                        <input type="text" name="gemIdTransfer" value={formData.gemIdTransfer}
                               onChange={handleInputChange}/>
                    </>
                )}
                ...
                <select name="creditSocietyClearance" value={formData.creditSocietyClearance}
                        onChange={handleInputChange}>
                ...
                <input type="radio" name="sapUser" value="yes" checked={formData.sapUser === 'yes'}
                       onChange={handleInputChange}/>
                <label>Yes</label>
                <input type="radio" name="sapUser" value="no" checked={formData.sapUser === 'no'}
                       onChange={handleInputChange}/>
                <label>No</label>
                ...
                <input type="radio" name="cpppUser" value="yes" checked={formData.cpppUser === 'yes'}
                       onChange={handleInputChange}/>
                <label>Yes</label>
                <input type="radio" name="cpppUser" value="no" checked={formData.cpppUser === 'no'}
                       onChange={handleInputChange}/>
                <label>No</label>
                ...
                <input type="radio" name="employeeCardReturn" id="e1" value="yes"
                       checked={formData.employeeCardReturn === 'yes'} onChange={handleInputChange}/>
                <label htmlFor="e1">Yes</label>
                <input type="radio" name="employeeCardReturn" id="e2" value="no"
                       checked={formData.employeeCardReturn === 'no'} onChange={handleInputChange}/>
                <label htmlFor="e2">No</label>

                <p>13. Reason for Applying NOC</p>
                <input type="radio" name="nocReason" id="n1" value="transfer"
                       checked={formData.nocReason === 'transfer'} onChange={handleInputChange}/>
                <label htmlFor="n1">Transfer</label>
                <input type="radio" name="nocReason" id="n2" value="retirement"
                       checked={formData.nocReason === 'retirement'} onChange={handleInputChange}/>
                <label htmlFor="n2">Retirement</label>

                <p>14. Have You Transferred out from Biometric Attendance System, RHQ, SR</p>
                <input type="radio" name="biometricTransfer" id="b1" value="yes"
                       checked={formData.biometricTransfer === 'yes'} onChange={handleInputChange}/>
                <label htmlFor="b1">Yes</label>
                <input type="radio" name="biometricTransfer" id="b2" value="no"
                       checked={formData.biometricTransfer === 'no'} onChange={handleInputChange}/>
                ...
                <input type="radio" name="officeDues" id="o1" value="yes" checked={formData.officeDues === 'yes'}
                       onChange={handleInputChange}/>
                <label htmlFor="o1">Yes</label>
                <input type="radio" name="officeDues" id="o2" value="no" checked={formData.officeDues === 'no'}
                       onChange={handleInputChange}/>
                <label htmlFor="o2">No</label>

                <p>16. Return of identity card and BCAS AEP No</p>
                <input type="radio" name="identityCardReturn" id="i1" value="yes"
                       checked={formData.identityCardReturn === 'yes'} onChange={handleInputChange}/>
                <label htmlFor="i1">Yes</label>
                <input type="radio" name="identityCardReturn" id="i2" value="no"
                       checked={formData.identityCardReturn === 'no'} onChange={handleInputChange}/>
