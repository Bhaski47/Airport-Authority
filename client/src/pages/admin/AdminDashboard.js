...
export default function AdminDashboard() {
    ...
    return (
        <div className={styles.container}>
            {isModalOpen ? <ConditionalForm setIsModalOpen={setIsModalOpen} /> :
...
const ConditionalForm = ({setIsModalOpen}) => {
    ...
    return (
        <div>
            ...
            <input type="datetime-local" id="dateOfApplying" />
            ...
            <p>12.Return of AAI Admin Card/Medical Card</p>
